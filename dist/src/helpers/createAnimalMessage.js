...
function createAnimalMessage(data, ctx) {
    ...
    if (typeof data === 'string') {
        ...
        ctx.replyWithPhoto(url ? url : 'sorry, something is wrong with photo, try again', telegraf_1.Markup.inlineKeyboard([telegraf_1.Markup.button.callback('One more photo', 'more')]));
    }
}
