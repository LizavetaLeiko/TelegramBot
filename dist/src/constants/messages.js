...
but unfortunately an error occurred and the text of the task was lost`,
    ...
    info: {
        helloMsg: (name) => `Hello ${name}, send me "/help" to see what i can do`,
        userCity: (city) => `Ok, your city is ${city}`,
        places: 'There is a list of places:',
        weatherSubscribed: (hour) => `Great! I will send you the forecast every morning at ${hour}:00`,
...
Create one by /task command`,
        taskReminder: (task) => `Don't forget about your task!
✅ ${task.title}
${task.text}`,
